...
const NoBrokerForNRIs = () => {
  ...
  return (
    ...
    <div className="position-relative">
        ...
        >
          <div className="container-fluid d-flex justify-content-between align-items-center px-4">
            ...
            <div className="d-flex align-items-center gap-3">
              {/* Phone Info Box */}
              <div
                className="d-flex align-items-center px-3 py-1 border border-success rounded"
                style={{
                  borderRadius: "8px",
                  fontWeight: "500",
                  color: "#00838f",
      ...
      {/* Outer wrapper with background only */}
      <div
        className="hero-wrapper d-flex justify-content-center"
        style={{
      ...
      >
        {/* Inner content container (full Bootstrap grid) */}
        <div className="container-fluid position-relative text-white" style={{ zIndex: 2, paddingTop: "90px", maxWidth: "1200px" }}>
          <div className="row align-items-start" style={{ minHeight: "100%" }}>
            ...
            <div className="col-lg-7 text-start">
              ...
              >
                ...
                {/* Banners */}
                {[
                  "https://assets.nobroker.in/nob-interior/home_loan_cx_banner_1.webp",
                  "https://assets.nobroker.in/nob-interior/home_loan_cx_banner_2.webp",
                  "https://assets.nobroker.in/nob-interior/home_loan_cx_banner_3.webp",
                ].map((src, index) => (
                  <div
                    key={index}
              ...
              <div className="card shadow-sm border-0 p-3 d-flex align-items-center justify-content-between free-sale-card flex-row mt-4">
                <div className="d-flex align-items-center">
            ...
            <div className="col-lg-6 ">
              <div
                className="card eligibility-card p-4 shadow-sm border-0 mt-5"
                style={{
                  maxWidth: "500px",
                  marginLeft: "40%",
              ...
              >
                ...
                <form>
                  ...
                  <div className="mb-3">
                    <label className="form-label">Property Finalized? *</label>
                    <div>
                  ...
                  <div className="form-check small mb-3">
                    ...
                    >
                      I consent to NoBroker being appointed as your authorized
                      representative to receive your credit info from Experian.{" "}
      ...
      <div className="container-fluid col-lg-5 col-md-8 col-sm-12" style={{ marginLeft: "290px" }}>
